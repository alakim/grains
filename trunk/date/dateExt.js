...
(function(){
	...
	var months = [
		new MonthDef("€нв", "€нварь", "€нвар€"),
		new MonthDef("фев", "февраль", "феврал€"),
		new MonthDef("мар", "март", "марта"),
		new MonthDef("апр", "апрель", "апрел€"),
		new MonthDef("май", "май", "ма€"),
		new MonthDef("июн", "июнь", "июн€"),
		new MonthDef("июл", "июль", "июл€"),
		new MonthDef("авг", "август", "августа"),
		new MonthDef("сен", "сент€брь", "сент€бр€"),
		new MonthDef("окт", "окт€брь", "окт€бр€"),
		new MonthDef("но€", "но€брь", "но€бр€"),
		new MonthDef("дек", "декабрь", "декабр€")
	];
