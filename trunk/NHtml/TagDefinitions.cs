...
namespace IVC.Markup {
	public static partial class Html {
		...
		/// <summary>Формирует тег DIV</summary>
		...
		/// <summary>Формирует тег P</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег SPAN</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег UL</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег OL</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег LI</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег INPUT</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег TEXTAREA</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег TABLE</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег TR</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег TH</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег TD</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег H1</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег H2</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег H3</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег H4</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег H5</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует тег H6</summary>
		/// <param name="content">контент</param>
		...
		/// <summary>Формирует описание атрибута type</summary>
		/// <param name="val">значение атрибута</param>
		public static string A_type(object val) {
			return Attribute("type", val);
		}

		/// <summary>Формирует описание атрибута title</summary>
		/// <param name="val">значение атрибута</param>
