(function($,$R,$D){
	...
	var signs = {
		...
		clefF: function(paper, x, y){
			var p = "M 0.13179,0.12439396 C 4.1817317,-2.8297519 7.9115217,-4.4973761 8.0817858,-10.475097 c 0.065844,-2.194199 -0.8498022,-4.397491 -3.2631256,-4.19264 -1.450263,0.194867 -2.2593114,0.633589 -2.9464861,1.780058 -0.1186454,0.257695 0,0.65255 0.4742036,0.672576 0.1783459,0 0.5739565,-0.157942 0.7915989,-0.178346 1.0277562,-0.118267 2.0470664,0.818552 1.8782999,1.602091 -0.6641864,3.0836463 -4.244213,1.6623409 -4.37060844,-0.336288 -0.0392966,-1.325125 0.83051764,-2.669899 2.05664574,-3.341719 3.8629317,-2.012048 8.0065882,0.204232 7.8865892,4.033837 C 10.405822,-4.5927263 4.6901312,-1.6209792 0.25005752,0.54003056 Z M 12.728604,-13.738222 c 0.652549,0 1.068186,0.534282 1.068186,1.068564 0,0.553174 -0.415637,1.087457 -1.068186,1.087457 -0.692224,0 -1.087457,-0.534283 -1.087457,-1.087457 0,-0.534282 0.395611,-1.068564 1.087457,-1.068564 z m 0,4.3309337 c 0.652549,0 1.068186,0.534282 1.068186,1.0681862 0,0.5535525 -0.415637,1.0878345 -1.068186,1.0878345 -0.692224,0 -1.087457,-0.534282 -1.087457,-1.0878345 0,-0.534282 0.395611,-1.0681862 1.087457,-1.0681862 z";
			paper.path(p).attr({fill:settings.signColor, "stroke-width":0}).transform(["T", x+5, y+19, "S", 1.6]);
		},
		...
		eighth: function(paper, x, y, colorIdx){
			if(colorIdx==null) colorIdx = -1;
			var p = "m 0.08408834,-5.9742575 c 0.09231,0.6870067 0.10514,1.5537818 0.78981512,2.4337724 1.04594204,1.2614927 2.41316404,2.6543194 2.43979704,4.2357318 1.95e-4,1.3578829 -0.65047,2.7567725 -1.097073,3.5526123 -0.07074,0.0039 -0.141677,0.0078 -0.212612,0.01108 0.31542,-0.7476448 0.944124,-1.9675434 0.891651,-3.2206748 -0.131169,-1.5410434 -1.299586,-3.1890705 -2.81157816,-3.3483562 l 0,7.772019 c 0,0.615488 -0.35603804,1.189775 -0.86969004,1.590707 C -1.6148916,7.61495 -2.7287025,7.875386 -3.465608,7.173516 -4.1896251,6.393298 -3.6620774,5.394884 -2.9947125,4.891527 -2.2536745,4.398804 -0.9318167,3.9303465 -0.2363847,4.575134 l 0,-10.551918 c 0.107083,0 0.213778,9.717e-4 0.32047304,0.00253 z";
			paper.path(p).attr({fill:colorIdx<0?settings.signColor:settings.color[colorIdx], "stroke-width":0}).transform(["T", x+2.5, y-7, "S", 1.9]);
		},
		sixteenth: function(paper, x, y, colorIdx){
			if(colorIdx==null) colorIdx = -1;
			var p = "m 0.22778992,0.18038732 c 0,0.73331744 -0.432683,1.41645208 -1.04435898,1.89214868 C -2.0205287,2.86062 -3.266322,2.8567164 -4.0051459,2.211753 -4.7439698,1.5667896 -4.4318772,0.20458435 -3.44481,-0.50344098 c 0.9870672,-0.70802532 2.1407076,-0.77721392 3.24847392,-0.372787 l 0,-12.56768702 c 0.141067,-2.31e-4 0.282365,2.32e-4 0.423664,0.0021 0.03145,0.588782 0.11586,1.409515 0.78997508,2.062817 1.4254421,1.364807 3.02492,2.9719323 3.045198,5.0027924 0,0.5173229 -0.0777,1.0496776 -0.217382,1.5547439 0.6492776,1.5119832 0.3770194,3.2165012 -0.362611,4.54744672 -0.08395,0.00694 -0.168356,0.013644 -0.252533,0.020119 C 4.1047356,-1.8751556 3.8658912,-4.0109823 3.284551,-4.7373043 2.7032108,-5.4636263 1.106337,-6.3221118 0.22755892,-6.9610762 c 2.31e-4,2.3805644 2.31e-4,4.7608975 2.31e-4,7.14146352 z M 3.658726,-6.2263694 c -0.3524936,-2.191119 -1.8521644,-3.2609182 -3.43093608,-4.2176736 0.03145,1.1740938 0.75852504,2.3838018 1.43148408,3.0271598 0.7247754,0.7077093 1.3773439,1.4069738 1.949732,2.2161407 0.03191,-0.3320857 0.06475,-0.7569057 0.04972,-1.0256269 z";
			paper.path(p).attr({fill:colorIdx<0?settings.signColor:settings.color[colorIdx], "stroke-width":0}).transform(["T", x+3.5, y-1.4, "S", 1.6]);
		},
		...
		rest1: function(paper, x, colorIdx){
			var p = "m 0.17602606,0.20664624 18.39285994,0 0,7.85714016 -18.39285994,0 z";
			var posY = settings.offset.y + settings.staffSize.h/2 - 8.5;
			paper.path(p).attr({fill:colorIdx<0?settings.signColor:settings.color[colorIdx], "stroke-width":0}).transform(["T", x-14, posY, "S", .5]);
		},
		rest2: function(paper, x, colorIdx){
			var p = "m 0.17602606,0.20664624 18.39285994,0 0,7.85714016 -18.39285994,0 z";
			var posY = settings.offset.y + settings.staffSize.h/2 - 6;
			paper.path(p).attr({fill:colorIdx<0?settings.signColor:settings.color[colorIdx], "stroke-width":0}).transform(["T", x-14, posY, "S", .5]);
		},
		rest4: function(paper, x, colorIdx){
			var p = "m 0.03697696,-20.234883 c 5.94223034,2.147455 9.83614224,8.838489 12.21112504,13.4521494 0,0 -6.6510551,5.0868509 -6.1871851,7.8286809 0.82024,4.84829 5.4947811,8.66234 7.7024111,11.6167497 0.51896,0.69541 -0.69687,1.36852 -2.39911,1.01016 0,0 -3.7880711,-2.14658 -5.3033011,-0.25254 -1.51523,1.89403 -2.01768,3.87998 2.9068202,11.20359 C 2.8079569,23.065047 -4.1363431,14.858097 0.14793696,10.174297 2.0729569,8.3341773 6.6336169,8.7393873 6.6336169,8.7393873 c -1.00606,-1.66211 -4.48826,-5.14124 -6.00226997,-6.68329 -1.18624994,-1.50950002 -1.57303994,-3.4714 -0.89920994,-4.57632 1.43594991,-2.35459 5.70862991,-5.68291 4.38878991,-8.5952703 -1.39108,-3.06956 -6.8065123,-10.103294 -4.08394994,-9.11939 z";
			var posY = settings.offset.y + settings.staffSize.h/4;
			paper.path(p).attr({fill:colorIdx<0?settings.signColor:settings.color[colorIdx], "stroke-width":0}).transform(["T", x, posY+5, "S", .4]);
		},
		rest8: function(paper, x, colorIdx){
			var p = "M 0.76795623,17.596222 10.678677,-6.0644975 9.2054564,-7.8948575 c -2.4167515,1.23195 -4.3120222,3.60941 -7.0982202,3.34822 2.26067,-7.3873705 -6.1385999,-7.5964605 -7.32142,-3.75 -1.47773,5.55625 3.3614101,7.30236997 4.24107012,7.45534997 1.02678994,0.17857 6.11606788,0.71429 8.48213918,-3.34820997 2.3660712,-4.0625 -8.30355918,20.2232195 -8.30355918,20.2232195 z";
			var posY = settings.offset.y + settings.staffSize.h/4;
			paper.path(p).attr({fill:colorIdx<0?settings.signColor:settings.color[colorIdx], "stroke-width":0}).transform(["T", x, posY+3, "S", .4]);
		},
		rest16: function(paper, x, colorIdx){
			var p = "m 0.10183626,-13.04297 c -1.78304996,-0.13119 -3.68172946,0.77616 -4.19920936,2.45899 -1.4777301,5.5562497 3.36056936,7.3020897 4.24022936,7.4550697 1.02679004,0.17857 6.11634974,0.71485 8.48241964,-3.34765 1.33111,-2.28549 -1.41957,4.27936 -4.1191396,10.5664 -1.9004,1.2569 -3.60536004,2.86401 -5.92578,2.64649 2.26066996,-7.38736996 -6.1394496,-7.59645996 -7.3222694,-3.75 -1.4777299,5.55625 3.3625299,7.3040503 4.24219,7.4570303 0.8364599,0.14547 4.81418936,0.61551 7.3741694,-1.4439103 C 0.51776626,15.64881 -1.541873 ,20.61411 -4.5898431,27.31836 l 1.8303594,1.5625 C 2.5464963,16.00517 6.9602359,4.2251997 11.795196,-8.3515603 L 10.320586,-10.18164 C 7.9038359,-8.9496903 6.009136,-6.5727903 3.2229363,-6.8339803 4.4945663,-10.98938 2.3943463,-12.8743 0.10183626,-13.04297 Z";
			var posY = settings.offset.y + settings.staffSize.h/4;
			paper.path(p).attr({fill:colorIdx<0?settings.signColor:settings.color[colorIdx], "stroke-width":0}).transform(["T", x, posY+1, "S", .4]);
		}
	};
	...
	function init(pnl, staff){
		...
		if(settings.clef=="f")
			signs.clefF(paper, settings.offset.x, settings.offset.y);
		else
			signs.clefG(paper, settings.offset.x, settings.offset.y);
		...
		function drawSequence(seq, groupMode){
			...
			function drawNote(paper, note, octave, alt, colorIdx, shift, accent, dot){
				...
				var sign = groupMode?signs.noteHead
					:{1:signs.whole, 2:signs.half, 4:signs.quarter, 8:signs.eighth, 16:signs.sixteenth}[duration]; 
